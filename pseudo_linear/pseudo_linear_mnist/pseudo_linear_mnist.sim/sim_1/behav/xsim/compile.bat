...
REM
REM Generated by Vivado on Wed Jan 04 16:51:56 +0000 2023
...
echo "xvlog --incr --relax -L uvm -prj mnist_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj mnist_tb_vlog.prj -log xvlog.log
